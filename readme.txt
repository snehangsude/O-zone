docker exec -it air-pollution-pipeline-postgres-1 psql -U admin_user -d airPollution_db
docker exec -it pyflink-docker-postgres-1 psql -h localhost -U flinkuser -d flinkdb
...
/opt/air-pollution/jobs/airPollution_postgre_sink.py